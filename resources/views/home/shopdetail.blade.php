                ...
                <div class="col-md-12">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li><a href="/home/shopdetail">Products</a></li>
                        </ul>
                    </div><!-- /.breadcrumbs -->
                </div><!-- /.col-md-12 -->
            </div><!-- /.row -->
                            ...
                            <div class="flexslider style-1 has-relative">
                                <ul class="slides">
                                    <li data-thumb="images/shop/sh-detail/thumb-detail-01.jpg">
                                        <img src="/1/images/shop/sh-detail/detail-01.jpg" alt="Image">
                                        <div class="flat-icon style-1">
                                            <a href="/1/images/shop/sh-detail/detail-01.jpg" class="zoom-popup"><span class="fa fa-search-plus"></span></a>
                                        </div>
                                    </li>
                                ...
                                <div class="content-inner">
                                    <div class="flat-grid-box col2 border-width border-width-1 has-padding clearfix">
                                        <div class="grid-row image-left clearfix">
                                            <div class="grid-item">
                                                <div class="thumb text-center">
                                                    <img src="/1/images/shop/sh-detail/detail-desc-01.jpg" alt="Image">
                                                </div>
                                            </div><!-- /.grid-item -->
                                            <div class="grid-item">
                                                <div class="text-wrap">
                                        ...
                                        <div class="grid-row image-right padding-bottom-48 clearfix">
                                            ...
                                            <div class="grid-item">
                                                <div class="thumb text-center">
                                                    <img src="/1/images/shop/sh-detail/detail-desc-02.jpg" alt="Image">
                                                </div>
                                            </div><!-- /.grid-item -->
                                        </div><!-- /.grid-row -->
                                        ...
                                        <div class="grid-row image-left padding-bottom-48 clearfix">
                                            <div class="grid-item">
                                                <div class="thumb text-center">
                                                    <img src="/1/images/shop/sh-detail/detail-desc-03.jpg" alt="Image">
                                                </div>
                                            </div><!-- /.grid-item -->
                                            <div class="grid-item">
                                                <div class="text-wrap">
                                        ...
                                        <div class="grid-row image-right clearfix">
                                            ...
                                            <div class="grid-item">
                                                <div class="thumb text-center">
                                                    <img src="/1/images/shop/sh-detail/detail-desc-04.jpg" alt="Image">
                                                </div>
                                            </div><!-- /.grid-item -->
                                        </div><!-- /.grid-row -->
                                    </div><!-- /.flat-grid-box -->
                                ...
                                <div class="content-inner">
                                    <div class="inner max-width-83 padding-top-33">
                                        <ol class="review-list">
                                            <li class="review">
                                                <div class="thumb">
                                                    <img src="/1/images/avatar-1.png" alt="Image">
                                                </div>
                                                <div class="text-wrap">
                                            ...
                                            <li class="review">
                                                <div class="thumb">
                                                    <img src="/1/images/avatar.png" alt="Image">
                                                </div>
                                                <div class="text-wrap">
                                                    <div class="review-meta">
